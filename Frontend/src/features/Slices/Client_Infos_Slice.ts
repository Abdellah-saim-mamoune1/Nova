...
export const fetchClientInfo = createAsyncThunk(
  ...
  async (_,thunkAPI) => {
    ...
    try {
      const response = await axios.get('http://localhost:8101/api/client/manage/client-info',{withCredentials:true});
...
export const fetchClientAccounts = createAsyncThunk(
  ...
  async () => {
    try {
      const response = await axios.get('http://localhost:8101/api/client/manage/accounts',{withCredentials:true});
...
export async function GetNotificationsPaginated(PageNumber:number,PageSize:number){
 try {
      const response = await axios.get(`http://localhost:8101/api/client/notifications/${PageNumber},${PageSize}`,{withCredentials:true});  
      return response.data; 
    } catch (error) {
...
export const GetNonReadNotificationsCount = createAsyncThunk(
  ...
  async () => {
   ...
   try {
      const response = await axios.get(`http://localhost:8101/api/client/notifications/non-read-notifications-count`,{withCredentials:true});  
      return response.data;
    } catch (error) {
      return null; 
    }
...
export async function TransactionsHistoryPaginatedGet(PageNumber:number,PageSize:number){
  try{
 const response=await axios.get(`http://localhost:8101/api/client/transactions/transactions-history/${PageNumber},${PageSize}`
...
export async function TransfersHistoryPaginatedGet(PageNumber:number,PageSize:number){
  try{
 const response=await axios.get(`http://localhost:8101/api/client/transactions/transfers-history/${PageNumber},${PageSize}`
  ,{withCredentials:true}
 );
...
export async function TransferFundAPI(data:ITransferData){
  try{
  const response=await axios.put(`http://localhost:8101/api/client/transactions/transfer-fund/`,data
  ,{
...
export async function LastMonthTransactionsHistoryGet(){
  try{
 const response=await axios.get(`http://localhost:8101/api/client/transactions/last-month-transactions-history`
  ,{withCredentials:true}
 );
