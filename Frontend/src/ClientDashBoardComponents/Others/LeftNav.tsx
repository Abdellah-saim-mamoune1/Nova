...
useEffect(() => {
  ...
  return (
    <div className="flex flex-col overflow-y-auto dark:bg-gray-800 dark:border-gray-800 bg-white bg-black/50 border-r border-gray-200 absolute w-[70%] z-15 lg:relative lg:w-[21%] h-screen shadow-sm">
