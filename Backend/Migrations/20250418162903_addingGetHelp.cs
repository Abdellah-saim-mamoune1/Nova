...
{
    /// <inheritdoc />
    public partial class addingGetHelp : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Subject = table.Column<string>(type: "nvarchar(31)", maxLength: 31, nullable: false),
                    Message = table.Column<string>(type: "nvarchar(401)", maxLength: 401, nullable: false)
                },
                constraints: table =>
                {
